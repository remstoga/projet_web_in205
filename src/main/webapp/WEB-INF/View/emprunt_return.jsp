	          ...
	          <div class="input-field col s12">
	            <select id="id" name="id" class="browser-default">
                  ...
                  <c:forEach items="${listEmprunt}" var ="emprunt">
                    <c:if test="${idDeLEmprunt == emprunt.getId()}">
                      <option value="${emprunt.getId()}" selected>${emprunt.getLivre().getTitre()} ${emprunt.getMembre().getPrenom()} ${emprunt.getMembre().getNom()}</option>
                    </c:if>
                    <c:if test="${idDeLEmprunt != emprunt.getId()}">                      
