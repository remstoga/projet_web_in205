      ...
      <div class="row">
        <div class="col l4 s6">
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>${countMembre}</h3> <!-- TODO : afficher le nombre de membres � la place de 12 -->
              <p>Membres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-green">
            <div class="inner">
              <h3>${countLivre}</h3> <!-- TODO : afficher le nombre de livres � la place de 27 -->
              <p>Livres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>${countEmprunt}</h3> <!-- TODO : afficher le nombre d'emprunts � la place de 1515 -->
              <p>Emprunts</p>
            </div>
            <div class="icon">
        ...
        <div class="container">
	        <div class="col s12">
	          ...
	          <table class="striped">   
                ...
                <tbody id="results">
                    <c:forEach items="${listCurrentEmprunt}" var="emprunt" varStatus="status">
                        <tr>
                            <td>${emprunt.livre.titre}</td>
                            <td>${emprunt.membre.prenom} ${emprunt.membre.nom}</td>
                            <td>${emprunt.dateEmprunt}</td>
                            <td>
                              <a href="emprunt_return?id=${emprunt.id}">Rendre le livre</a>
                          </td>
                        </tr>
                    </c:forEach>
